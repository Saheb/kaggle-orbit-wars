...
`orbit-wars-heuristic-agent-scored-1000`.

Use this as a submit-ready baseline candidate only after review. It is not an
original replacement for the local learning-baseline agent.
"""
import os
