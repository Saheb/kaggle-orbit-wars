"""Final submitted presres1 0.5M 2p payload, loaded from the tracked tarball."""
import os
import tarfile

_ARCHIVE = os.path.abspath("final_submissions/submission_presres05.tar.gz")
with tarfile.open(_ARCHIVE, "r:gz") as _tar:
    _SOURCE = _tar.extractfile("neural_agent.py").read()
_GLOBALS = {
    "__name__": "_submitted_presres05_neural",
