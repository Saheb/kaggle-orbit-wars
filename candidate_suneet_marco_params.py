"""
Review candidate copied from the public Kaggle kernel:
`suneetsaini/lb-1200-orbit-wars-ppo-strategy`, with selected Marco v3.3
conservative parameters.

This is currently the strongest pulled public candidate in local slot-0 testing:
it beat the Zach public baseline but lost the Marco public baseline. Do not
submit or replace main.py without review.
"""
